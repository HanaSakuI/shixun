...
function dTree(objName, objbool) {        // void 构造方法，创建树对象。objName: 树名称。objbool：单选多选 true多选  false单选  默认单选         
    ...
    this.icon = {
        root: '../../JS/dTree/img/base.gif',         // Node 根节点。
        folder: '../../JS/dTree/img/folder.gif',       // Node 根节点。
        folderOpen: '../../JS/dTree/img/folderopen.gif',   // 打开的文件夹,默认'img/folderOpen.gif'
        node: '../../JS/dTree/img/page.gif',         // 打开的文件夹,默认'img/folderOpen.gif'
        empty: '../../JS/dTree/img/empty.gif',        // 打开的文件夹,默认'img/folderOpen.gif'
        line: '../../JS/dTree/img/line.gif',         // 竖线,默认'img/line.gif'
        join: '../../JS/dTree/img/join.gif',         // 丁线,默认'img/join.gif'
        joinBottom: '../../JS/dTree/img/joinbottom.gif',   // 直角线,默认'img/joinbottom.gif'
        plus: '../../JS/dTree/img/plus.gif',         // 加号丁线,默认'img/plus.gif'
        plusBottom: '../../JS/dTree/img/plusbottom.gif',   // 加号直角线,默认'img/plusbottom.gif'
        minus: '../../JS/dTree/img/minus.gif',        // 减号丁线,默认'img/minus.gif'
        minusBottom: '../../JS/dTree/img/minusbottom.gif',  // 减号直角线,默认'img/minusbottom.gif'
        nlPlus: '../../JS/dTree/img/nolines_plus.gif', // 减号直角线,默认'img/minusbottom.gif'
        nlMinus: '../../JS/dTree/img/nolines_minus.gif' //无线减号,默认'img/nolines_minus.gif'
    };
